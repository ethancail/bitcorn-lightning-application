...
const METRICS: MetricConfig[] = [
  ...
  { key: "reserve_risk",      label: "Reserve Risk",            description: "Confidence-weighted HODL score",                chartUrl: "https://studio.glassnode.com/charts/indicators.ReserveRisk",                 typicalRange: "typical: 0.002 to 0.02; can reach ~0.0008 in deep undervaluation", decimals: 7, tier: "paid",    tierNote: "Paid tier required" },
  ...
  { key: "difficulty_ribbon", label: "Difficulty Ribbon",       description: "Compression of 9 difficulty MAs",               chartUrl: "https://studio.glassnode.com/charts/indicators.DifficultyRibbonCompression", typicalRange: "typical: 0.005 to 0.08; can drop below 0.001 during stable difficulty periods", decimals: 7, tier: "paid",    tierNote: "Paid tier required" },
  { key: "miner_outflows",    label: "Miner Outflow Multiple", description: "Miner outflow ÷ 365-day MA (USD)",              chartUrl: "https://studio.glassnode.com/charts/mining.MinersOutflowMultiple?a=BTC",       typicalRange: "0.5 to 3",     decimals: 3, tier: "paid",    tierNote: "Paid tier required" },
